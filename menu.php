<nav class="modulos">
    ...
    <div class="modulo azul">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=api&file=leitura_arquivo">
                    Leitura de Arquivos
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=api&file=uploud_arquivo">
                    Uploud de Arquivo
                </a>
            </li>
            <li>
    ...
    <div class="modulo verde">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=tratamento_erros&file=try_catch">
                    Try & Catch
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=tratamento_erros&file=erros_personalizados">
                    Erros Personalizados
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=tratamento_erros&file=desafio_erros">
                    Desafio Erros
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=tratamento_erros&file=gerenciador_error">
                    Error Handler
                </a>
            </li>
        </ul>
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=includes&file=include_retorno">
                    Include de Retorno
                </a>
            </li>
            <li>
